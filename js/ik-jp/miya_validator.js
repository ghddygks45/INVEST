...
MiyaValidator.ERROR_MESSAGE = {
    /* for element */
    required   : "必ず入力してください。",
    requiredstring : "{required}で入力してください。",
    match      : "入力した内容が一致しません。",
    invalid    : "入力した内容に誤りがあります。",
    min        : "{min}以上の数値を入力してください。 ",
    max        : "{max}以下の数値を入力してください。",
    minlength  : "{minlength}文字以上で入力してください。",
    minbyte    : "{minbyte}Byteで入力してください。",
    maxbyte    : "{maxbyte}Byteを超過できません。",
    mincheck   : "{mincheck}項目以上を選択してください。",
    maxcheck   : "{maxcheck}項目以下で選択してください。",
    minselect  : "{minselect}項目以上から選択してください。",
    maxselect  : "{maxselect}項目以下で選択してください。",
    imageonly  : "画像ファイルのみ登録できます。",
    fileonly   : "{fileonly}ファイルのみ登録できます。",

    /* for group */
    requiremin : "{requiremin}項目以上を入力してください。",
    requiremax : "{requiremax}項目以下を入力してください。",

    /* for format */
    email      : "メールアドレスに誤りがあります。",
    hangul     : "ハングルで入力してください。",
    engonly    : "英語で入力してください。",
    number     : "数字で入力してください。",
    residentno : "住民登録番号に誤りがあります。",
    jumin      : "住民登録番号に誤りがあります。",
    foreignerno: "外国人登録番号に誤りがあります。",
    bizno      : "事業者登録番号に誤りがあります。",
    phone      : "電話番号に誤りがあります。",
    fax        : "ファクス番号に誤りがあります。",
    homephone  : "固定電話番号に誤りがあります。",
    handphone  : "携帯電話番号に誤りがあります。",
    isdate     : "日付に誤りがあります。",
    zip        : "郵便番号に誤りがあります。",
    jurino     : "法人番号に誤りがあります。",
    engnum     : "英数字のみ入力してください。",
    numcpcl    : "数字、（*,-）のみ入力してください。",
    password   : "パスワードは9文字以上、1文字以上の数字および英大文字と特殊文字を含めて入力してください。",
    url        : "入力された内容に誤りがあります。",
    idreg      : "英小文字、数字を含めて入力してください。",
