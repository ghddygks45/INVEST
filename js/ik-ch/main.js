...
$(function(){
    ...
    $('.sec03 .tab-menu>li').on('click', function(){
        $(this).parent('.tab-menu').children('li').removeClass('active');
        $(this).addClass('active');
        var idx = $(this).index();
        $(this).closest($('.tab-area')).find($('.tab-contents')).removeClass('active');
        $(this).closest($('.tab-area')).find($('.tab-contents')).eq(idx).addClass('active').slick('setPosition');
    })
    ...
    $('.scroll-btn').on('click', function(){
        ...
        $( 'html, body' ).animate( { scrollTop : offset - headerHeight }, 400 );
    })
