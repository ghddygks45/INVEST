...
MiyaValidator.ERROR_MESSAGE = {
    /* for element */
    required   : "You must answer {required}. (or: You must fill in {required})",
    requiredstring : "Input data must be {required}.",
    match      : "Input data is not in a valid format.",
    invalid    : "Input data is incorrect.",
    min        : "Input value must be a number greater than {min}.",
    max        : "Input value must be a number less than {max}.",
    minlength  : "Input data must contain more than {minlength}characters.",
    minbyte    : "Input data must be longer than {minbyte}bytes.",
    maxbyte    : "Input data must not be longer than {maxbyte}bytes.",
    mincheck   : "Please check off more than {mincheck} answer choices.",
    maxcheck   : "Please check off less than {maxcheck} answer choices.",
    minselect  : "Please check off more than {minselect} answer choices.",
    maxselect  : "Please check off less than {maxselect} answer choices.",
    imageonly  : "You can attach image files only. (or: Picture attachments only )",
    fileonly   : "You can attach {fileonly} only.(or: {fileonly} attachments only)",

    /* for group */
    requiremin : "You must select more than {requiremin} options.",
    requiremax : "You must select less than {requiremax} options.",

    /* for format */
    email      : "Your e-mail adress format is incorrect. (or: Invalid email address)",
    hangul     : "Fill in Korean only.",
    engonly    : "Fill in English only.",
    number     : "Fill in numbers only.",
    residentno : "Your resident registration number is invalid.",
    jumin      : "Your resident registration number is invalid.",
    foreignerno: "Your alien registration number is invalid.",
    bizno      : "Your business license number is invalid.",
    phone      : "Your phone number is invalid.",
    fax        : "Your fax number is invalid.",
    homephone  : "Your phone number is invalid.",
    handphone  : "Your mobile phone number is invalid.",
    isdate     : "The date is invalid.",
    zip        : "Your postal code is invalid.",
    jurino     : "Your corporate registration number is invalid.",
    engnum     : "Text input accepts English or numeric characters only.",
    numcpcl    : "Text input must be numeric or special characters (*, -)",
    password   : "Your password must be a combination of more than 9 alphanumeric characters. It also must contain at least one capital letter, number digit and special character.",
    url        : "Input data is not in a valid format.(or: Input data is incorrect.)",
    idreg      : "Input data must be alphanumeric characters with at least one lower-case letter.",
